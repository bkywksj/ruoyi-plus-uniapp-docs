...
export default defineConfig({
    ...
    themeConfig: {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { text: 'useImageCompress 图片压缩', link: '/mobile/composables/use-image-compress' },
        ...
        socialLinks: [
            {
                icon: 'github',
                link: 'https://github.com/bkywksj/ruoyi-plus-uniapp-docs'
            }
        ],

        // 编辑链接
        editLink: {
            pattern: 'https://github.com/bkywksj/ruoyi-plus-uniapp-docs/edit/master/docs/:path',
