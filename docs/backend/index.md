...
基于 Spring Boot 3 + MyBatis-Plus 进行深度重构，提供了查询增强组件、统一响应封装、完善的多租户 SaaS
...
| **权限控制** | 基础权限      | 增强权限              | ✅ useAuth钩子+延迟加载组件                     |
| **主题切换** | 基础主题      | 主题支持              | ✅ useTheme钩子                           |
| **国际化**  | 基础i18n    | 增强i18n            | ✅ useI18n钩子+智能提示+后端国际化                 |
| **表格增强** | 基础表格      | el-table+vxetable | ✅ el-table+useSelection+useTableHeight |
| **文件下载** | 基础下载      | 基础下载              | ✅ useDownload钩子                        |
| **动画效果** | 基础动画      | CSS动画             | ✅ useAnimation钩子                       |
