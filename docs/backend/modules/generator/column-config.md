...
|------|----------|----------|----------|----------|------|------|------|------|------|------|------|----------|----------|----------|------|
| 1 | id | 用户ID | bigint | Long | 是 | 是 | 是 | 否 | 否 | 是 | 是 | = | 文本框 | | 编辑 |
| 2 | username | 用户名 | varchar(50) | String | 否 | 否 | 是 | 是 | 是 | 是 | 是 | LIKE | 文本框 | | 编辑 |
| 3 | status | 状态 | char(1) | String | 否 | 否 | 是 | 是 | 是 | 是 | 是 | = | 单选框 | sys_normal_disable | 编辑 |
