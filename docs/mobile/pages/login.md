...
/* 暗黑模式 */
.dark {
  --login-bg: var(--bg-base, #1a1a1a);
  --login-card-bg: var(--bg-level-1, #2c2c2c);
  --login-title-color: var(--text-primary, #ffffff);
  --login-desc-color: var(--text-secondary, #999999);
  --login-border-color: var(--border-color, #3a3a3a);
}
</style>
```
...
.brand-theme {
  ...
  --login-btn-bg: linear-gradient(90deg, #667eea 0%, #764ba2 100%);
}
...
.minimal-theme {
  ...
  --login-border-color: #f0f0f0;
  --login-card-radius: 0;
  --login-input-radius: 8rpx;
}
...
.business-theme {
  ...
  --login-title-color: #f9fafb;
  --login-desc-color: #9ca3af;
  --login-border-color: #4b5563;
