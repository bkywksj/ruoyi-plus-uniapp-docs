...
| 平台 | 支持状态 | 说明 |
|------|---------|------|
| 微信小程序 | 是 完整支持 | 主要目标平台，功能最完善 |
| 支付宝小程序 | 是 完整支持 | 已配置独立 appid |
| QQ 小程序 | 是 完整支持 | 已配置独立 appid |
| 百度小程序 | 是 完整支持 | 已配置独立 appid |
| 抖音小程序 | 是 完整支持 | 字节跳动小程序 |
| 快手小程序 | 是 支持 | 已配置基础设置 |
| 飞书小程序 | 是 支持 | 已配置基础设置 |
| 京东小程序 | 是 支持 | 已配置基础设置 |
| 小红书小程序 | 是 支持 | 已配置基础设置 |
| 鸿蒙小程序 | 是 支持 | HarmonyOS 小程序 |

### H5 平台

| 特性 | 支持状态 | 说明 |
|------|---------|------|
| History 路由 | 是 支持 | 默认使用 history 模式 |
| HTTPS | 是 支持 | 可配置 HTTPS 开发服务器 |
| 响应式布局 | 是 支持 | 完整的响应式设计方案 |
| 微信公众号 | 是 支持 | 支持微信公众号 H5 应用 |

### App 平台

| 平台 | 支持状态 | 最低版本 |
|------|---------|---------|
| Android | 是 支持 | minSdkVersion 30 |
| iOS | 是 支持 | - |
| HarmonyOS | 是 支持 | App-Harmony |
