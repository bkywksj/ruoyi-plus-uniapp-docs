...
| 技术 | 版本 | 说明 | 选型理由 |
|------|------|------|---------|
| **Java** | 21 | 编程语言 | - LTS长期支持版本<br>- 虚拟线程等新特性<br>- 性能提升显著 |
| **Spring Boot** | 3.5.6 | 应用框架 | - 约定优于配置<br>- 生态完善<br>- 快速开发 |
| **MyBatis-Plus** | 3.5.14 | ORM框架 | - 增强MyBatis<br>- 代码生成<br>- 高效便捷 |
| **Sa-Token** | 1.44.0 | 权限认证 | - 轻量灵活<br>- 功能强大<br>- 文档完善 |
| **Redis** | 7.x | 缓存中间件 | - 高性能<br>- 数据结构丰富<br>- 主流选择 |
| **Redisson** | 3.51.0 | Redis客户端 | - 分布式锁<br>- 集合操作<br>- 生产级 |
| **MySQL** | 8.0+ | 关系数据库 | - 开源免费<br>- 性能优秀<br>- 成熟稳定 |
